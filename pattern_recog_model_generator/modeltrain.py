...
parser.add_argument(
    "--checkpoint",
    default="pattern_recog_model_generator/pattern_model.h5",
    type=str,
...
parser.add_argument(
    "--x_data",
    default=os.path.realpath(os.path.dirname(__file__)) + "/data/x.npy",
    type=str,
    help="x data file name",
)
parser.add_argument(
    "--y_data",
    default=os.path.realpath(os.path.dirname(__file__)) + "/data/y.npy",
    type=str,
    help="y data file name",
)


class Model:
    def __init__(
        self, loss, learning_rate, epochs, batch_size, model_filename, x_file, y_file
    ):
        # initialization
        self.loss = loss
